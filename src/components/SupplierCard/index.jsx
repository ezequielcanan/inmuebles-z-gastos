...
const SupplierCard = ({ title, referrer, setReload, budgets, id }) => {
  ...
  return <div className="relative">
    <Link to={`/suppliers/${id}`} className="bg-secondary shadow-[10px_10px_15px_0px_#f5401c] cursor-pointer border-primary flex flex-col justify-between gap-y-4 py-6 px-3 text-black duration-300 hover:shadow-[10px_10px_15px_0px_#a3201a]">
